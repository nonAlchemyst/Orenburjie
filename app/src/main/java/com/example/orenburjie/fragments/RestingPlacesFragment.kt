...
class RestingPlacesFragment(private val item: Item): BaseFragment<RestingPlacesViewModel>(RestingPlacesViewModel::class.java, R.layout.fragment_resting_places) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        resting_places_page1.setOnClickListener {
            viewModel.toDescriptionFragment(item)
        }
