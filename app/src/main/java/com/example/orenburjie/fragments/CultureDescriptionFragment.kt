...
class CultureDescriptionFragment(private val item: Item): BaseFragment<DescriptionScreenViewModel>(DescriptionScreenViewModel::class.java, R.layout.fragment_culture_description) {
