...
class ExcursionsDescriptionFragment(private val item: Item): BaseFragment<DescriptionScreenViewModel>(DescriptionScreenViewModel::class.java, R.layout.fragment_excursions_description) {
