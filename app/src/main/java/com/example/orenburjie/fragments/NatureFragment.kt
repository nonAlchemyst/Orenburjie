...
class NatureFragment: BaseFragment<NatureViewModel>(NatureViewModel::class.java, R.layout.fragment_nature) {

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        viewModel.setDataReceivingListener(object : ICulture.DataReceiving{
            override fun onSuccess() {
                nature_menu_list?.let{
        ...
        nature_page_2.setOnClickListener { viewModel.showZapovedniki() }
    }
