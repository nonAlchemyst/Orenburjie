...
class ExcursionsInfoFragment(private val item: Item): BaseFragment<RestingPlacesViewModel>(RestingPlacesViewModel::class.java, R.layout.fragment_excursions_info) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        excursions_info_page_1.setOnClickListener {
            viewModel.toExcursionsDescriptionFragment(item)
        }
